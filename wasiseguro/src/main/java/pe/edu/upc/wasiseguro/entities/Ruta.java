...
public class Ruta {
    ...
    public Ruta(UUID id, Usuario usuario, double origenLat, double origenLng, double destinoLat, double destinoLng, String nombreOrigen, String nombreDestino, BigDecimal distanciaKm, BigDecimal duracionMin, String nivelRiesgo, String geojsonTrayecto, boolean esPublica, LocalDateTime createdAt) {
        this.id = id;
